...
1.  **Check for User Input:**
    -   The user provided the following arguments: the user-provided arguments passed to this skill.
...
2.  **Auto-Detect Scope:**
    ...
    -   If one exists, immediately prompt the user (do not repeat the question in the chat):
        - **Header:** "Review Track"
...
3.  **Handle User Response:**
    ...
    *   **If "Delete":**
        i.   **Confirm:** Immediately prompt the user to ask for final confirmation (do not repeat the warning in the chat):
            - **Header:** "Confirm"
