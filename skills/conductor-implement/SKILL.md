...
4. **Select Track:**
   - **If a track name was provided:**
     ...
     2. If a unique match is found, immediately prompt the user to confirm the selection with:
        - **Header:** "Confirm"
        - **Question:** "I found track '<track_description>'. Is this correct?"
        - **Type:** yes/no
     3. If no match is found, or if the match is ambiguous, immediately prompt the user to inform them and request the correct track name:
        - **Header:** "Clarify"
   ...
   - **If no track name was provided (or if the previous step failed):**
     ...
     2. **If a next track is found:**
        - Immediately prompt the user to confirm the selection with:
          - **Header:** "Next Track"
          - **Question:** "No track name provided. Would you like to proceed with the next incomplete track: '<track_description>'?"
          - **Type:** yes/no
        - If confirmed, proceed with this track. Otherwise, immediately prompt the user to request the correct track name:
          - **Header:** "Clarify"
...
2. **Ask for User Choice:** Immediately prompt the user with:
...
3. **Handle User Response:**
   ...
   * **If user chooses "Delete":**
     i. **CRITICAL WARNING:** Before proceeding, immediately prompt the user for final confirmation with:
        - **Header:** "Confirm"
