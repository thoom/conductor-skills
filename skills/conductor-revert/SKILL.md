    ...
    *   **PATH B: Guided Selection Menu**
        ...
        2.  **Present a Unified Hierarchical Menu:** Immediately prompt the user with the results:
            ...
            - **Options:** Provide the identified items as options. Group them by Track in the description if possible. **CRITICAL:** You MUST limit this list to a maximum of 4 items.
                ...
                - **Note:** Also offer an "Other" option for custom input.
        3.  **Process User's Choice:**
            ...
            *   If the user selects "Other", you must engage in a dialogue to find the correct target by prompting the user for free text input.
...
3.  **Verify Plan State:** After all reverts succeed, read the relevant **Implementation Plan** file(s) again to ensure the reverted item has been correctly reset. If not, edit the file to fix it and commit the correction.
