...
3.  **Interaction Paths:**
    ...
    *   **PATH A: Direct Confirmation**
        ...
        2.  Immediately prompt the user for confirmation:
            ...
            - **Type:** yes/no
        3.  If "yes", establish this as the `target_intent` and proceed to Phase 2. If "no", immediately prompt the user with a clarifying question:
            - **Header:** "Clarify"
    ...
    *   **PATH B: Guided Selection Menu**
        ...
        2.  **Present a Unified Hierarchical Menu:** Immediately prompt the user to choose from the results:
            - **Header:** "Select Item"
            ...
            - **Options:** Provide the identified items as options. Group them by Track in the description if possible. **CRITICAL:** You MUST limit this array to a maximum of 4 items.
                ...
                - **Note:** Include an "Other" option so the user can specify a different target.
        3.  **Process User's Choice:**
            ...
            *   If the user selects "Other", you must engage in a dialogue to find the correct target by prompting with a single text question.
...
3.  **Process User Choice:**
    ...
    - If "Revise", immediately prompt the user for the correct plan:
        - **Header:** "Revise"
